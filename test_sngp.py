"""
    Script for testing SNGP Baseline
"""

import tensorflow as tf
import tensorflow_datasets as tfds
from resNetSNGP import resnet_sngp
...
if __name__ == '__main__':
    ...
    resNet18 = resnet_sngp(stages=[64,128,256,512],N=2,in_filters=64, in_shape=(28,28,1), n_out = 10,
                           gp_hidden_dim=1024, gp_scale=1.0, gp_bias=0., gp_input_normalization=False,gp_random_feature_type='rrf', gp_cov_discount_factor=0.999, gp_cov_ridge_penalty=1.0)
